...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- Seed data (self-seeds on first open) ----------
     User #1 mirrors the mock admin session written by
     admin-login.html (userId 1, admin@yatra.com). */
  const SEED_USERS = [
    {
      id: 1,
    ...
    },
    {
      id: 2,
      name: 'Anju Karki',
      email: 'anju.karki@example.com',
      phone: '9841234567',
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-01T10:20:00.000Z'
    },
    {
      id: 3,
      ...
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-05T14:45:00.000Z'
    },
    {
      id: 4,
      name: 'Sanjay Thapa Magar',
      email: 'sanjay.tm@example.com',
      phone: '9801122334',
      role: 'USER',
      status: 'Inactive',
      registeredAt: '2026-09-06T08:10:00.000Z'
    },
    {
      id: 5,
      name: 'Prakriti Rai',
      email: 'prakriti.rai@example.com',
      phone: '9856234781',
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-08T16:30:00.000Z'
    },
    {
      id: 6,
      name: 'Nirmala Gurung',
      email: 'nirmala.g@example.com',
      phone: '9845612309',
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-09T11:05:00.000Z'
    },
    {
      id: 7,
      name: 'Dipesh Neupane',
      email: 'dipesh.n@example.com',
      phone: '9861250974',
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-10T19:40:00.000Z'
    },
    {
      id: 8,
      name: 'Sarita Lamichhane',
      email: 'sarita.l@example.com',
      phone: '9849056172',
      role: 'USER',
      status: 'Inactive',
      registeredAt: '2026-09-11T07:55:00.000Z'
    },
    {
      id: 9,
      name: 'Kabin Bhandari',
      email: 'kabin.b@example.com',
      phone: '9807341285',
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-12T13:15:00.000Z'
    },
    {
      id: 10,
      name: 'Manish Pokhrel',
      ...
      role: 'USER',
      status: 'Active',
      registeredAt: '2026-09-13T17:25:00.000Z'
    }
  ];
